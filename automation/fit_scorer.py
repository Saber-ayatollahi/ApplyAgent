...
_FALLBACK_SYSTEM_PROMPT = (
    ...
    "demonstrably has: ALM/IRRBB modelling, cash-flow projection engines, formal\n"
    "sign-off authority, LDI strategy, model validation/governance, vendor-platform\n"
    "implementation (Aladdin/Bloomberg/MSCI/S&P/PFaroe), Python/agentic-AI workflows,\n"
    "or sector experience (pension/insurer/Big 6/vendor).\n"
    "\n"
