...
6. OSFI hook selection: E-23 for validation roles, B-12 for bank IRRBB roles, LAR 2026 for    liquidity roles, IFRS 17 for insurers, None for pensions and vendors.
...
> **Rule:** 300–350 words. Three paragraphs. Lead with the regulatory hook or the platform-parallel hook — never with your education. One specific thing about the company in paragraph 2. Close with availability.
...
With OSFI's {{osfi_hook_specific_guideline}} {{hook_driver_sentence}}, {{target_company}}'s {{target_team}} is building exactly the capability where I have spent my career. I would like to be considered for the {{role_title}} role.

I currently hold sign-off authority on valuation, sensitivity, and ALM outputs for multi-asset institutional portfolios at Moody's Analytics, where I led the design of a multi-scenario cash-flow projection engine and operate IRRBB analytics under parallel and non-parallel rate shocks. My team-of-one mandate covers curve construction review, spread calibration, cross-asset interaction analysis, and escalation of outputs that are mathematically defensible but economically unsupported — the precise discipline {{target_company}}'s {{osfi_hook_specific_guideline}} implementation will demand. Before Moody's I delivered IFRS 17 and IFRS 9 transformation at EY, and stochastic ALM and LDI studies for Canadian pension funds at Ortec Finance. I hold the CFA charter and dual MSc degrees in Financial Modelling and Chemical Engineering from Western University.

What draws me specifically to {{target_company}} is {{specific_company_hook_one_sentence — e.g., "the scale of your IRRBB build-out ahead of the 2026 B-12 revision" or "your leadership position in Canadian Schedule I balance-sheet risk" or "the depth of the model governance framework you are positioning for E-23 2027"}}. My practitioner background — sign-off on portfolios in the $5–25bn range, Python-modernized workflows, and agentic-AI-accelerated development — maps directly onto what I understand your {{target_team}} is asking of this role.
...
With OSFI's B-12 IRRBB revision entering consultations this quarter and setting the direction for how Canadian banks will measure non-trading interest rate risk through 2027, Scotiabank's ALM Modelling Team in Treasury is building exactly the capability where I have spent my career. I would like to be considered for the Director, ALM Modelling role.

I currently hold sign-off authority on valuation, sensitivity, and ALM outputs for multi-asset institutional portfolios at Moody's Analytics, where I led the design of a multi-scenario cash-flow projection engine and operate IRRBB analytics under parallel and non-parallel rate shocks. My mandate covers curve construction review, spread calibration, cross-asset interaction analysis, and escalation of outputs that are mathematically defensible but economically unsupported — the precise discipline Scotiabank's IRRBB build-out ahead of B-12 will demand. Before Moody's I delivered IFRS 17 and IFRS 9 transformation at EY, and stochastic ALM and LDI studies for Canadian pension funds at Ortec Finance. I hold the CFA charter and dual MSc degrees in Financial Modelling and Chemical Engineering from Western University.

What draws me specifically to Scotiabank is the scope of the Director, ALM Modelling role — leading a quantitative team of seven to design, develop, and support the ALM models used to measure IRRBB across the bank's balance sheet. My practitioner background — sign-off on portfolios in the $5–25bn range, Python-modernized workflows, and agentic-AI-accelerated development — maps directly onto what this mandate requires. I would bring the immediate ability to stress-test methodology choices against both the current IRRBB landscape and the direction B-12 is likely to take.
...
Between EY's IFRS 17 transformation practice and Ortec Finance's pension-ALM advisory team, I spent four years delivering the exact kind of regulatory-driven risk and ALM advisory work that {{target_company}}'s {{target_practice_name}} practice is scaling ahead of {{regulatory_hook — e.g., "OSFI E-23 implementation in 2027" or "the B-12 IRRBB revision taking effect across Canadian banks"}}. I would like to be considered for the {{role_title}} role.
...
- ❌ Open with "I am writing to apply for…". Boring. Use a regulatory or platform-parallel hook.
